...
def find_green_stems(input_file, corners):
    # Read the image
    ...
    # Step 3: Find contours above a certain area. The area is determined by the box from the red tomatoes
    # area_height = 
    # box = corners # (x, y, w, h)
...
def process_all_images(input_path, output_path):
    for filename in os.listdir(input_path):
        if filename.endswith(".jpg"):
            ...
            # image = find_green_stems(input_file)
...
# main
def main(argv):
    input_path = "/home/jeroen/Documents/Python3/opencv/images/"
    output_path = "/home/jeroen/Documents/Python3/opencv/processed/"
    if argv[1] == "all":
